            ...
            <div className="w-full flex flex-col md:flex-row gap-4">
              ...
              <div className="md:max-w-[60%] paragraph-work_sans leading-[28px] text-wrap">
                <p>
                  ...
                  guiding our students to become outstanding leaders, grounded
                  in integrity, confidence, and respect. Our main goal is to
                  provide a comprehensive education that fosters intellectual
                  curiosity, emotional well-being, and moral strength in each
                  child.
                </p>
                <br />
                <p>
